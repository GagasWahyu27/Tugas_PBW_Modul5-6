...
<head>
    ...
    <title>Tugas prak pbw 5&6</title>
</head>
<body>
        ...
        <form action="update.php" method="POST">
            <table>
                ...
                <tr>
                    <td>Nama Dosen</td>
                    <td>
                        <input type="text" name="nama_dosen" id="" value="<?php echo $d['nama_dosen']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>Jenis Kelamin</td>
                ...
                <tr>
                    <td>Tahun Masuk</td>
                    <td>
                        <input type="text" name="tahun_masuk" id="" value="<?php echo $d['tahun_masuk']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>Agama</td>
